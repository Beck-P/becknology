...
const RocketPlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.RocketPlayback })));
const SpaceInvadersPlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.SpaceInvadersPlayback })));
const BombPlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.BombPlayback })));
const PlinkoPlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.PlinkoPlayback })));
const BattleRoyalePlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.BattleRoyalePlayback })));
const StockMarketPlayback = React.lazy(() => import('./HeavyModePlaybacks').then((module) => ({ default: module.StockMarketPlayback })));
